...
export class ToDoCreater extends Component {
    ...
    render = () =>
        <div className="my-1">
            <input className="form-control" value={this.state.newToDoItem} onChange={this.updateNewToDoItemFunction}/>
            <button className="btn btn-primary mt-1" onClick={this.createNewToDoFunction}>ADD</button> 
        </div>
}